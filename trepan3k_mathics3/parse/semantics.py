...
from trepan3k_mathics3.parse.parser import LocationError as PLocationError
from trepan3k_mathics3.parse.parser import parse_bp_location
...
class LocationGrok(GenericASTTraversal, object):
    ...
    def n_FUNCNAME(self, node):
        self.result = Location(None, None, False, node.value, offset=0)
        ...
        if 1 <= node_len <= 2:
            ...
            if last_node == "location":
                ...
                self.result = ListRange(
                    Location(None, None, False, last_node.value, offset=0), None
                )
    ...
    def n_range(self, range_node):
        ...
        if 1 <= node_len <= 2:
            ...
            if last_node == "location":
                ...
                self.result = ListRange(
                    Location(None, None, False, last_node.value, offset=None), None
                )
